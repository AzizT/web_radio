            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php if (internauteEstConnecte()) : ?>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="../navigation_interne/index_70.php"><button class="btn btn-sm btn-outline-success" type="button">70' Albums</button></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="../navigation_interne/index_80.php"><button class="btn btn-sm btn-outline-success" type="button">80' Albums</button></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="../navigation_interne/index_90.php"><button class="btn btn-sm btn-outline-success" type="button">90' Albums</button></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="../navigation_interne/index_00.php"><button class="btn btn-sm btn-outline-success" type="button">00' Albums</button></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="../navigation_interne/index_10.php"><button class="btn btn-sm btn-outline-success" type="button">10' Albums</button></a>
                        </li>
                        <li class="nav-item">
